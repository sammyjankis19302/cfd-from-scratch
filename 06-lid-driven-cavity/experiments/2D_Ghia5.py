...
plt.savefig("pictures/Re_400_t100_101x/stream_function")
plt.show()
...
plt.title("Vorticity")
plt.axis("equal")
plt.savefig("pictures/Re_400_t100_101x/vorticity_t100.png")
plt.show()
...
plt.savefig("pictures/Re_400_t100_101x/v_adn_u_function_t100.png")
plt.show()
