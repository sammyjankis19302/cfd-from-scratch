...
plt.savefig("pictures/Re_100_t100/stream_function")
plt.show()
...
plt.title("Vorticity")
plt.axis("equal")
plt.savefig("pictures/Re_100_t100/vorticity_t100.png")
plt.show()
...
plt.savefig("pictures/Re_100_t100/v_adn_u_function_t100.png")
plt.show()
