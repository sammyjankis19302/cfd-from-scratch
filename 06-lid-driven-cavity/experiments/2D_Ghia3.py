...
plt.savefig("pictures/Re_100_t100_51x/stream_function")
plt.show()
...
plt.title("Vorticity")
plt.axis("equal")
plt.savefig("pictures/Re_100_t100_51x/vorticity_t100.png")
plt.show()
...
plt.savefig("pictures/Re_100_t100_51x/v_adn_u_function_t100.png")
plt.show()
